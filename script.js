document.addEventListener('DOMContentLoaded', () => {
    ...
    const teamData = [
        {
            name: "Oana Borodi",
            role: "Fondator / Medic Veterinar Coordonator",
            quote: "Pasiunea pentru animale și rigoarea medicală sunt pilonii pe care am construit Happy Pets. Fiecare pacient primește nu doar tratament, ci și toată atenția noastră.",
            image: "oana borodi.jpg"
        },
        {
